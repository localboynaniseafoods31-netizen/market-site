...
import { ArrowRight, ChevronRight, Timer, Tag } from "lucide-react";
...
const BANNERS = [
    ...
    },
    {
        ...
        description: "Experience premium seafood with zero delivery charges.",
    ...
    {
        id: 3,
        title: "Steak Festival",
        subtitle: "Seer Fish Steaks @ ₹750",
        description: "Perfectly sliced, ready for your grill.",
...
export default function DiscountBanner({ deals }: DiscountBannerProps) {
    ...
    // Fallback if no deals passed
    // const displayDeals = deals.length > 0 ? deals : DEALS;
                ...
                <div className="relative w-full h-[220px] md:h-[300px] overflow-hidden rounded-3xl shadow-xl shadow-sky-900/5">
                    <AnimatePresence mode="wait">
                        <motion.div
                            ...
                            className={`absolute inset-0 w-full h-full bg-gradient-to-r ${BANNERS[currentBanner].bgColor} flex items-center`}
                        >
                            <div className="flex w-full h-full relative">
                                ...
                                <div className="w-2/3 md:w-1/2 h-full p-6 md:p-10 flex flex-col justify-center text-white z-10 pb-10 md:pb-10">
                                    ...
                                    >
                                        PROMO: {BANNERS[currentBanner].code}
                                    </motion.span>
                ...
                <div className="space-y-4 pt-4">
                    <div className="flex items-center justify-between px-1">
                        <h3 className="text-lg md:text-xl font-bold text-foreground flex items-center gap-2">
                            ...
                            Flash Sale <span className="text-sm font-normal text-muted-foreground">| Expires in 02:45:10</span>
                        </h3>
                        <Link href="/category/deals">
